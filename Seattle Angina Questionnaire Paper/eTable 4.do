...
program adjustlogit
melogit `1' i.intervention i.step || centerid:, or
end
...
xi:qreg2 `1' intervention i.step,cluster(centerid)  quantile(.50)
end
...
meologit multinomialangina i.intervention i.step || centerid:, or
